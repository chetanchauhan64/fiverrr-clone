...
const replacements = [
    ...
    { from: /fiverr-primary/g, to: 'skillbridge-primary' },
    { from: /fiverr-title/g, to: 'skillbridge-title' },
    { from: /fiverr-subtitle/g, to: 'skillbridge-subtitle' },
    { from: /fiverr-text/g, to: 'skillbridge-text' },
    { from: /fiverr-label/g, to: 'skillbridge-label' },
    { from: /fiverr-card/g, to: 'skillbridge-card' },
    { from: /fiverr-section-py/g, to: 'skillbridge-section-py' },
...
console.log(`Starting comprehensive rebranding in: ${path.resolve(targetDir)}`);
